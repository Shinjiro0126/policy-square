...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const theme = createTheme({
    ...
    typography: {
      ...
      subtitle1: { fontSize: "20px", lineHeight: 1.5, fontWeight: 700 },
      subtitle2: { fontSize: "16px", lineHeight: 1.5, fontWeight: 700 },
      body1: { fontSize: "16px", lineHeight: 1.5, fontWeight: 400 },
      body2: { fontSize: "12px", lineHeight: 1.5, fontWeight: 400 },
      caption: { fontSize: "12px", lineHeight: 1.5, fontWeight: 300 },
      button: { fontWeight: 600, lineHeight: 1.5, textTransform: 'none' },
      overline: { fontSize: "12px", lineHeight: 1.5, fontWeight: 600 },
      rank: {
